...
library Whites {
    ...
    function setWhiteList(White storage white, address _address, uint256 _rate) public {
    ...
    function deleteWhiteList(White storage white, address _address) public {
        require(_address != address (0), "invalid _address");
        delete white.whiteList[_address];
    }


    function getBridgeFee(White storage white, address msgSender, address token, uint256 bridgeFee) public view   returns(uint256) {
    ...
    function getBridgeFeeTimes(White storage white, address msgSender, address token, uint256 times, uint256 bridgeFee) public view  returns(uint256) {
