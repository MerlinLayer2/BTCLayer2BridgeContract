...
console.log(`BridgeErc20 Contract Proxy Addr: ${deployOutput.bTCLayer2BridgeERC20DeployContract}`)
...
async function main() {
    ...
    const BridgeFactory = await ethers.getContractFactory("BTCLayer2BridgeERC20", owner);
    ...
    console.log('bridge-erc20 deployed to:', bridge.target);
}
